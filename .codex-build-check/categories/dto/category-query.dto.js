...
class CategoryQueryDto extends pagination_query_dto_1.PaginationQueryDto {
    search;
}
exports.CategoryQueryDto = CategoryQueryDto;
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Tìm theo tên danh mục', maxLength: 200 }),
